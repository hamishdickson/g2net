...
def train_loop(folds, fold):
    ...
    train_dataset = datasets.TrainDataset(CFG, train_folds, transform=get_transforms(data='train'))
    valid_dataset = datasets.TrainDataset(CFG, valid_folds, transform=get_transforms(data='train'))
    ...
    for epoch in range(CFG.epochs):
        ...
        ave_valid_loss, preds = engine.valid_fn(
            valid_loader,
            model,
            criterion
        )
